...
<img src="images/top-header.jpg" />
	...
	<h3>MENS CATEGORIES</h3>
		<ul >
        	<?php
	mysql_connect("$host", "$user", "$pass") or die (mysql_error());	
	mysql_select_db("$db") or die(mysql_error());
	$strSQL = "SELECT DISTINCT manufacturer FROM item WHERE category= 'men' ";
	...
	//echo "<li><a href=office_electronics.php?itemnumber=0&rows=0&category=office&manufacturer=".$manufacturer. ">".$manufacturer."</a></li>";
		echo "<li><a href=office_electronics.php?itemnumber=0&rows=0&category=men&manufacturer=$manufacturer>".$manufacturer."</a></li>"; 

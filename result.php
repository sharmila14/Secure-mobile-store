...
<div id="inner_contentColumn" class="middlecolumn" align="center" >
    ...
    $query="select * from item where itemnumber >'".$itemnumber."' and  (category like '".$lstr."'or description like '".$lstr."'or price  like '".$lstr."')or manufacturer like '".$lstr."' ORDER BY itemnumber";	
...
if ($row['price']>0)	 
	...
	$cells=0;
	  ...
	  if($numberofrows>16)	  
 echo "</tr><tr><td colspan='3' align='center' ><a href=result.php?itemnumber=". $row['itemnumber']."align=right>Next</a></td>";
	}
